...
const RELEASES_LATEST_URL = "https://github.com/adrianchiu1/clawd-on-chiu-desk/releases/latest";
...
function initUpdater(ctx, deps = {}) {
  ...
  function fetchLatestReleaseViaRedirect() {
    return new Promise((resolve, reject) => {
      const req = httpsGet({
        hostname: "github.com",
        path: "/adrianchiu1/clawd-on-chiu-desk/releases/latest",
        headers: {
  ...
  function fetchLatestReleaseFromApi() {
    return new Promise((resolve, reject) => {
      ...
      const req = httpsGet({
        ...
        path: "/repos/adrianchiu1/clawd-on-chiu-desk/releases/latest",
        headers,
      }, (res) => {
